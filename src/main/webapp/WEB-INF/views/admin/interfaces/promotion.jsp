              ...
              <div class="d-flex aligns-items-center justify-content-center card text-left w-50 position-absolute top-50 start-50 translate-middle-x" id="product_edit" style="margin-left: 100px;margin-top: -15%;;" aria-hidden="true">
                <div class="card mb-4">
                  ...
                  <div class="card-body" style="margin-top: -3%;">
                    ...
                    <div class="mb-3">
                      <label for="defaultFormControlInput" class="form-label">Promotion Name</label>
                      <input
                        type="text"
                        class="form-control"
                    ...
                    <div class="mb-3">
                      <label for="defaultFormControlInput" class="form-label">Promotion Rate</label>
                      <input
                        type="number"
                        min="0" max="10000"
                        class="form-control"
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Promotion Details</label>
