    ...
    <div class="layout-container">
        ...
        <div class="layout-page" >
            ...
            <div class="content-wrapper" >
                ...
                <div class="container-xxl flex-grow-1 container-p-y" id="blur-action">
                    ...
                    <div class="card">
                        <div style="display: flex; flex-direction: row; justify-content: space-between; align-items:center ; padding: 10px;">
                            <div class="col-md-3">
                                <form id="searchForm" action="/brand/search" style="display: flex;flex-direction: row" method="post">
                            ...
                            <table class="table">
                                ...
                                <c:if test="${brandList != null}">
                                    <c:forEach var="brand" items="${brandList}">
                                        <tr>
                                            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>${brand.id}</strong></td>
                                            <td>${brand.name}</td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" id="edit_btn" onclick="btnEdit(${brand.id})" href="javascript:void(0);">
                                                            <i class="bx bx-edit-alt me-1"></i>
                                                            Edit
                                                        </a>
                                                        <a class="dropdown-item" onclick="deleteBrand(${brand.id})" href="javascript:void(0);"
                ...
                <!-- / Content -->
                <!--/ Basic Bootstrap Table -->
                <form id="updateForm" action="/brand/updateBrand" method="post">
                            ...
                            <div class="card-body" style="margin-top: -3%;">
                                ...
                                <div class="row mt-3">
                                    <div class="d-grid gap-2 col-lg-6 mx-auto">
                                        <button class="btn btn-primary btn-lg" onclick="updateBrand()" type="button">Save</button>
                                    </div>
                                    <div class="d-grid gap-2 col-lg-6 mx-auto">
                ...
                <!--/ Responsive Table -->
                <!--/ Create Table -->
                <form id="saveForm" action="/brand/saveBrand" method="post" enctype="multipart/form-data">
