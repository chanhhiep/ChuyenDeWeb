    ...
    <div class="layout-container">
        ...
        <div class="layout-page" >
            ...
            <div class="content-wrapper" >
                ...
                <div class="container-xxl flex-grow-1 container-p-y" id="blur-action">
                    ...
                    <div class="card">
                        <div style="display: flex; flex-direction: row; justify-content: space-between; align-items:center ; padding: 10px;">
                            <div class="col-md-3">
                                <form id="searchForm" action="/discount/search" style="display: flex;flex-direction: row" method="post">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" id="edit_btn" onclick="btnEdit(${discount.id})" href="javascript:void(0);">
                                                            <i class="bx bx-edit-alt me-1"></i>
                                                            Edit
                                                        </a>
                                                        <a class="dropdown-item" onclick="deleteDiscount(${discount.id})" href="javascript:void(0);"
                ...
                <!-- / Content -->
                <!--/ Basic Bootstrap Table -->
                <form id="updateForm" action="/discount/updateDiscount" method="post">
                            ...
                            <div class="card-body" style="margin-top: -3%;">
                                ...
                                <div class="row mt-3">
                                    <div class="d-grid gap-2 col-lg-6 mx-auto">
                                        <button class="btn btn-primary btn-lg" onclick="updateDiscount()" type="button">Save</button>
                                    </div>
                                    <div class="d-grid gap-2 col-lg-6 mx-auto">
                ...
                <!--/ Responsive Table -->
                <!--/ Create Table -->
                <form id="saveForm" action="/discount/saveDiscount" method="post" enctype="multipart/form-data">
