...
<div class="acc">
  <div class="form-box">
    <div class="button-box">
      <div id="btn"></div>
      <button type="button" class="toggle-btn" onclick="login()"><a href="/login">Log In</a></button>
      <button type="button" class="toggle-btn"  onclick="register()"><a href="/register">Register</a></button>
    </div>
    <form id="register" action="/register" method="post" class="input-group">
      ...
      <div class="input-field">
        ...
        <input type="password" class="form-input" id="pass1" name="password" placeholder="Enter password"
