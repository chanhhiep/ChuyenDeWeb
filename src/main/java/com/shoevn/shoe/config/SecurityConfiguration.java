package com.shoevn.shoe.config;

import com.shoevn.shoe.config.filter.ChainExceptionHandlerFilter;
import com.shoevn.shoe.config.filter.JwtAuthenticationFilter;
        ...
        http
                .cors(cors ->{
                    CorsConfigurationSource source = request -> {
                     ...
                     configuration.setAllowedMethods(Arrays.asList("GET","POST","PUT","PATCH","DELETE","OPTIONS","BASE_URL"));
